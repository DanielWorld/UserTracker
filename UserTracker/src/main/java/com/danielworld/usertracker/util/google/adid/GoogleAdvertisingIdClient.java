package com.danielworld.usertracker.util.google.adid;
...
/**
 * 구글 광고 ID 가져오는 핵심기능 <br>
 *     메인 쓰레드에서 실행하지 않을것을 권한다. <br>
...
//                LOG.i(TAG, "Advertising ID: " + id);
            ...
            protected void onPostExecute(String adId) {
                // Do not save this ad ID in SharedPreferences. Not necessary.
