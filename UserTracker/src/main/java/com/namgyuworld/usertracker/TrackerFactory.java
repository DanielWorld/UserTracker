...
public class TrackerFactory {
    ...
    public static List<TrackingModel> newFirstRunTracking(String tag){
        ...
        return tracking.getTrackingList();
    }
    public static List<TrackingModel> newForegroundTracking(String tag){
    ...
    public static List<TrackingModel> newBackgroundTracking(String tag){
    ...
    public static List<TrackingModel> newActionTracking(String action, String param){
    ...
    private static void addCommonInfo(TrackingModel tracking){
        ...
        tracking.putValuePair(TrackingMapKey.GOOGLE_ACCOUNT, "");
